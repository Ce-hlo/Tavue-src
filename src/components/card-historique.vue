...
<p class="absolute left-5 top-[414px] text-[25px] font-extralight text-left text-black">
    Personnalisation modèle 1
  </p>
  <p class="absolute left-5 top-[472px] text-[25px] font-extralight text-left text-black">
    description
  </p>
  <p class="absolute left-[307px] top-[472px] text-[25px] font-extralight text-left text-black">
    75 €
  </p>
</div>
</div>
